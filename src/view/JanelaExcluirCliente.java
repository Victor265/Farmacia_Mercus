...
import control.ExcluirCliente;

public class JanelaExcluirCliente extends JFrame implements ActionListener {
	...
	public JanelaExcluirCliente(String titulo) {
		super("Farmácia Mercus - Excluir Cliente");
		...
		this.jlCabecalho = new JLabel("Excluir através do CPF");
	...
	public void actionPerformed(ActionEvent evento) {
		if (evento.getSource() == this.btOk) {
			...
			excCliente.excluiCliente(jtCpf.getText(), conexao.getConexao());
			dispose();
		}
