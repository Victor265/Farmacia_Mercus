...
public class JanelaCadastrarMedicamentos extends JFrame implements
		ActionListener {
	...
	public JanelaCadastrarMedicamentos(String Titulo) {
		super("Farmácia Mercus - Cadastrar Medicamentos");
	...
	public void actionPerformed(ActionEvent evento) {
		if (evento.getSource() == this.btOk) {
			CadastrarMedicamentos cMedicamento = new CadastrarMedicamentos();
			cMedicamento.cadastrarmedicamento(jtFormula.getText(),
		...
		if (evento.getSource() == this.btVoltar) {
			dispose();
			JanelaCadastrarMedicamentos jcc = new JanelaCadastrarMedicamentos(
