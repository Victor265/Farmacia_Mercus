...
public class JanelaCadastrarClientes extends JFrame implements ActionListener {
	...
	public JanelaCadastrarClientes(String Titulo) {
		super("Farmácia Mercus - Cadastrar Clientes");
		...
		this.jlCpf.setBounds(10, 60, 50, 30);
		this.jtCpf.setBounds(100, 60, 100, 30);
		...
		this.jlRg.setBounds(220, 60, 50, 30);
		this.jtRg.setBounds(240, 60, 110, 30);
		this.jlNumero.setBounds(10, 150, 100, 30);
		this.jtNumero.setBounds(100, 150, 250, 30);
		this.jlComplemento.setBounds(10, 180, 100, 30);
		this.jtComplemento.setBounds(100, 180, 250, 30);
		this.jlBairro.setBounds(10, 210, 100, 30);
		this.jtBairro.setBounds(100, 210, 250, 30);
		this.jlCidade.setBounds(10, 240, 100, 30);
		this.jtCidade.setBounds(100, 240, 250, 30);
	...
	public void actionPerformed(ActionEvent evento) {
		if (evento.getSource() == this.btOk) {
			CadastraCliente cCliente = new CadastraCliente();
			cCliente.cadastrarCliente(jtCpf.getText(), jtRg.getText(), jtNome
					.getText(), jtBairro.getText(), jtCidade.getText(), jtCep
					.getText(), jtLogradouro.getText(),
					jtNumero.getText(), jtComplemento.getText(),
					jtTelefone1.getText(), jtTelefone2.getText(), conexao.getConexao());
